...
| `MED250_GATE_DATA_REUSE_APPROVED` | Data owner | Signed approval + review ledger | Complete `docs/launch/evidence/data-reuse-review-ledger-pending-2026-07-16.json`, resolve its raw-snapshot and permission blockers, approve reuse/publication of every product, pharmacy, contact, GIS and indicative-price source, and attach the separate signed approval. |
