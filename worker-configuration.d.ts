/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=production --env-file=/dev/null` (hash: 7e4521a903927ecc2f032f478b02f41c)
// Runtime types generated with workerd@1.20260708.1 2026-08-23 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MED250_RELEASE_MODE" | "MED250_BACKEND_MODE" | "NEXT_PUBLIC_MED250_DEPLOYMENT_MODE" | "NEXT_PUBLIC_MED250_INDEXING_MODE" | "NEXT_PUBLIC_MED250_DEPLOYMENT_ORIGIN" | "NEXT_PUBLIC_MARKETPLACE_MODE" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_MED250_OBSERVABILITY">> {}
}
