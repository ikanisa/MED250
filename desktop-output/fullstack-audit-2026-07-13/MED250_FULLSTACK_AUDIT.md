...
9. **Help, policy and failure states — healthy.** How it works, privacy, terms, accessibility, loading, not-found and application-error surfaces exist and share the same design system.
