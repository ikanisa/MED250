...
const providerValues = {
  ...
  TWILIO_CLIENT_LOCATION_CAPTURE_CONTENT_SID: `HX${"1".repeat(32)}`,
  TWILIO_CLIENT_LOCATION_CHOICE_CONTENT_SID: `HX${"2".repeat(32)}`,
  TWILIO_CUSTOMER_OTP_CONTENT_SID: `HX${"3".repeat(32)}`,
  TWILIO_PHARMACY_CLIENT_MEDIA_REQUEST_CONTENT_SID: `HX${"4".repeat(32)}`,
  TWILIO_PHARMACY_OTP_CONTENT_SID: `HX${"5".repeat(32)}`,
  TWILIO_PHARMACY_REQUEST_CONTENT_SID: `HX${"6".repeat(32)}`,
};
