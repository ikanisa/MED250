...
export default function PrivacyPage() {
  return <InfoShell eyebrow="PRIVACY" title="Privacy at MED+250" intro="This notice explains the product behaviour implemented in the current marketplace. It should be reviewed with Rwandan legal and regulatory advisers before public launch.">
    <section><h2>Information used to place an order</h2><p>MED+250 uses your selected products, quantities, fulfilment preference, location, WhatsApp number, and any prescription you choose to attach. Anonymous sign-in identifies a browser session; it does not make order or health data anonymous.</p></section>
