...
const MAX_PERSISTED_CART_ITEMS = 100;
...
export default function Marketplace({
  ...
  useEffect(() => {
    ...
    writeExpiringStorage(window.localStorage, CART_STORAGE_KEY, cart.slice(0, MAX_PERSISTED_CART_ITEMS), CART_STORAGE_TTL_MS);
  }, [cart, cartHydrated]);
  ...
  useEffect(() => {
    ...
    try {
      const parsed = readExpiringStorage(window.sessionStorage, CUSTOMER_PREFERENCES_STORAGE_KEY) as Partial<CustomerPreferences> | null;
      if (parsed) {
