...
export default function AboutPage() {
  return <InfoShell eyebrow="ABOUT MED+250" title="A clearer route from medicine search to pharmacy confirmation" intro="MED+250 is a Rwanda-focused pharmacy marketplace. It organises governed product information and helps a customer send one availability request to pharmacies that may be able to help.">
    ...
    <section className="info-callout"><h2>Start with a governed search</h2><p>Find a medicine by the detail you know, then review the request and confirmation boundaries before continuing.</p><div className="info-actions"><Link href="/find-medicine">Find a medicine</Link><Link href="/trust">Trust centre</Link></div></section>
  </InfoShell>;
}
