...
export default function TermsPage() {
  return <InfoShell eyebrow="MARKETPLACE TERMS" title="Using MED+250" intro="MED+250 is an information and pharmacy-connection marketplace. Customers search one central catalogue, request availability, and continue directly with a pharmacy on WhatsApp.">
    <section><h2>Marketplace role</h2><p>MED+250 publishes central product information and indicative From RWF prices. It helps customers identify pharmacies that confirm availability for a private request. MED+250 does not publish pharmacy-specific stock or price lists.</p></section>
